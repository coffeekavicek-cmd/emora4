...
## EMORA Demo V2 additions

This prototype includes the product direction discussed for EMORA:

- **EMORA Express** — premium ready-made gift templates.
- **EMORA Smart** — AI-assisted personalized gifts.
- **EMORA Studio** — conversational AI website-builder demo for business, store, portfolio, CV/resume, restaurant and custom sites.
- **UZ / RU / EN** language switcher on the main product shell.
- **Click / Payme demo checkout** only; no real money is charged.
- Custom domain is positioned as a future paid add-on for Studio.

See `DEMO_PAYMENT.md` for the payment simulation notes.


## PREMIUM V3 DEMO
Frontend rebuilt with working UZ/RU/EN localization, 12 animated Express templates, local photo/video/music live preview, Smart AI chat demo, Studio AI website builder demo, and Click/Payme demo checkout.
